...
static func all() -> Array:
	return [
		{ "id": "first_day", "name": "FIRST DAY", "desc": "Finish your first shift. everyone remembers their first.",
			"counter_key": "games_played", "target": GameConfig.COMMENDATION_FIRST_DAY_TARGET, "tier": TIER_EASY },
		{ "id": "punching_in", "name": "PUNCHING IN", "desc": "Finish 10 shifts. it's a habit now.",
			"counter_key": "games_played", "target": GameConfig.COMMENDATION_PUNCHING_IN_TARGET, "tier": TIER_EASY },
		{ "id": "career_clerk", "name": "CAREER CLERK", "desc": "Finish 100 shifts. this is your life.",
			"counter_key": "games_played", "target": GameConfig.COMMENDATION_CAREER_CLERK_TARGET, "tier": TIER_MED },
		{ "id": "exterminator", "name": "EXTERMINATOR", "desc": "2,500 lifetime kills. pest control was cheaper.",
			"counter_key": "total_kills", "target": GameConfig.COMMENDATION_EXTERMINATOR_TARGET, "tier": TIER_EASY },
		{ "id": "genocide_shift", "name": "GENOCIDE SHIFT", "desc": "25,000 lifetime kills. the town is mostly you now.",
			"counter_key": "total_kills", "target": GameConfig.COMMENDATION_GENOCIDE_SHIFT_TARGET, "tier": TIER_HARD },
		{ "id": "pest_control", "name": "PEST CONTROL", "desc": "Kill 100 elites (lifetime). the tough ones don't die twice.",
			"counter_key": "total_elites", "target": GameConfig.COMMENDATION_PEST_CONTROL_TARGET, "tier": TIER_MED },
		{ "id": "middle_management", "name": "MIDDLE MANAGEMENT", "desc": "Defeat 25 bosses (lifetime). paperwork included.",
			"counter_key": "total_bosses", "target": GameConfig.COMMENDATION_MIDDLE_MANAGEMENT_TARGET, "tier": TIER_MED },
		{ "id": "upper_management", "name": "UPPER MANAGEMENT", "desc": "Defeat 100 bosses (lifetime). the closet is now a corner office.",
			"counter_key": "total_bosses", "target": GameConfig.COMMENDATION_UPPER_MANAGEMENT_TARGET, "tier": TIER_HARD },
		{ "id": "dawn_patrol", "name": "DAWN PATROL", "desc": "Survive 1 Dawn Extraction. you made it to the parking lot.",
			"counter_key": "shifts_survived", "target": GameConfig.COMMENDATION_DAWN_PATROL_TARGET, "tier": TIER_EASY },
		{ "id": "week_one", "name": "WEEK ONE", "desc": "Survive 5 shifts via Dawn Extraction. that's a whole week.",
			"counter_key": "shifts_survived", "target": GameConfig.COMMENDATION_WEEK_ONE_TARGET, "tier": TIER_MED },
		{ "id": "employee_of_the_month", "name": "EMPLOYEE OF THE MONTH", "desc": "Reach a 7-day login streak. dedication, or nowhere else to be.",
			"counter_key": "daily_streak", "target": GameConfig.COMMENDATION_EMPLOYEE_OF_MONTH_TARGET, "tier": TIER_MED },
		{ "id": "regular", "name": "REGULAR", "desc": "Play 10 Daily Shifts. same time, same zombies.",
			"counter_key": "dailies_played", "target": GameConfig.COMMENDATION_REGULAR_TARGET, "tier": TIER_MED },
		{ "id": "golden_ticket", "name": "GOLDEN TICKET", "desc": "Pull an Armageddon. molten gold. 1-in-362,880.",
			"counter_key": "armageddons_pulled", "target": GameConfig.COMMENDATION_GOLDEN_TICKET_TARGET, "tier": TIER_HARD },
		{ "id": "over_the_rainbow", "name": "OVER THE RAINBOW", "desc": "Pull an Apocalypse. somewhere over the rainbow, apparently.",
			"counter_key": "apocalypse_pulled", "target": GameConfig.COMMENDATION_OVER_THE_RAINBOW_TARGET, "tier": TIER_MED },
		{ "id": "big_spender", "name": "BIG SPENDER", "desc": "Open 50 crates (lifetime). the odds don't care how many you buy.",
			"counter_key": "crates_opened_total", "target": GameConfig.COMMENDATION_BIG_SPENDER_TARGET, "tier": TIER_MED },
		{ "id": "recycler", "name": "RECYCLER", "desc": "Fuse 10 weapons (lifetime). one gun, assembled from its friends.",
