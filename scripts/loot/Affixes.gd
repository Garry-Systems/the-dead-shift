...
static func all() -> Array:
	return [
		...
		{ "id": "r2_rapid", "name": "Rapid", "rarity": 2, "signature": "fire_rate", "min_stats": 1, "max_stats": 2, "min_talents": 0, "max_talents": 1, "stats": { "fire_rate": [8, 16], "reload": [6, 14] } },
		{ "id": "r2_longshot", "name": "Longshot", "rarity": 2, "signature": "range", "min_stats": 1, "max_stats": 2, "min_talents": 0, "max_talents": 1, "stats": { "range": [12, 24], "bullet_speed": [10, 28] } },
		{ "id": "r3_razor", "name": "Razor", "rarity": 3, "signature": "damage", "min_stats": 2, "max_stats": 2, "min_talents": 1, "max_talents": 1, "stats": { "damage": [20, 40], "range": [14, 26] } },
		{ "id": "r3_rapid", "name": "Rapid", "rarity": 3, "signature": "fire_rate", "min_stats": 2, "max_stats": 2, "min_talents": 1, "max_talents": 1, "stats": { "fire_rate": [12, 22], "reload": [10, 22] } },
		{ "id": "r3_heavy", "name": "Heavy", "rarity": 3, "signature": "mag", "min_stats": 2, "max_stats": 2, "min_talents": 1, "max_talents": 1, "stats": { "mag": [14, 30], "damage": [14, 28] } },
		{ "id": "r4_razor", "name": "Razor", "rarity": 4, "signature": "damage", "min_stats": 2, "max_stats": 3, "min_talents": 1, "max_talents": 2, "stats": { "damage": [32, 58], "range": [20, 36], "fire_rate": [12, 22] } },
		{ "id": "r4_heavy", "name": "Heavy", "rarity": 4, "signature": "multishot", "min_stats": 2, "max_stats": 3, "min_talents": 1, "max_talents": 2, "stats": { "mag": [20, 40], "multishot": [1, 1], "damage": [24, 44] } },
		{ "id": "r4_hollow", "name": "Hollow", "rarity": 4, "signature": "pierce", "min_stats": 2, "max_stats": 3, "min_talents": 1, "max_talents": 2, "stats": { "pierce": [1, 1], "multishot": [1, 1], "damage": [20, 40] } },
		{ "id": "r4_longshot", "name": "Longshot", "rarity": 4, "signature": "range", "min_stats": 2, "max_stats": 3, "min_talents": 1, "max_talents": 2, "stats": { "range": [24, 42], "bullet_speed": [18, 40], "damage": [20, 40] } },
		{ "id": "r5_razor", "name": "Razor", "rarity": 5, "signature": "damage", "min_stats": 3, "max_stats": 4, "min_talents": 2, "max_talents": 2, "stats": { "damage": [48, 84], "fire_rate": [18, 30], "range": [28, 48], "bullet_speed": [15, 40] } },
		{ "id": "r5_heavy", "name": "Heavy", "rarity": 5, "signature": "multishot", "min_stats": 3, "max_stats": 4, "min_talents": 2, "max_talents": 2, "stats": { "mag": [28, 55], "multishot": [1, 2], "damage": [36, 64], "reload": [15, 30] } },
		{ "id": "r5_hollow", "name": "Hollow", "rarity": 5, "signature": "pierce", "min_stats": 3, "max_stats": 4, "min_talents": 2, "max_talents": 2, "stats": { "pierce": [1, 2], "multishot": [1, 2], "damage": [32, 60], "range": [24, 44] } },
		...
		{ "id": "r6_razor", "name": "Razor", "rarity": 6, "signature": "damage", "min_stats": 3, "max_stats": 5, "min_talents": 2, "max_talents": 3, "stats": { "damage": [64, 110], "fire_rate": [28, 44], "range": [36, 60], "bullet_speed": [25, 55], "reload": [25, 45] } },
		{ "id": "r6_heavy", "name": "Heavy", "rarity": 6, "signature": "multishot", "min_stats": 3, "max_stats": 4, "min_talents": 2, "max_talents": 3, "stats": { "mag": [38, 75], "multishot": [2, 3], "damage": [48, 88], "reload": [25, 45] } },
		{ "id": "r6_hollow", "name": "Hollow", "rarity": 6, "signature": "pierce", "min_stats": 3, "max_stats": 4, "min_talents": 2, "max_talents": 3, "stats": { "pierce": [1, 3], "multishot": [2, 3], "damage": [44, 84], "ricochet": [1, 1] } },
		{ "id": "r6_brutal", "name": "Brutal", "rarity": 6, "signature": "multishot", "min_stats": 4, "max_stats": 5, "min_talents": 2, "max_talents": 3, "stats": { "damage": [56, 100], "multishot": [2, 3], "pierce": [1, 3], "ricochet": [1, 1], "fire_rate": [28, 44] } },
		{ "id": "r7_razor", "name": "Razor", "rarity": 7, "signature": "damage", "min_stats": 4, "max_stats": 6, "min_talents": 3, "max_talents": 3, "stats": { "damage": [85, 145], "fire_rate": [35, 55], "range": [45, 75], "bullet_speed": [40, 80], "reload": [35, 60], "mag": [40, 80] } },
		{ "id": "r7_heavy", "name": "Heavy", "rarity": 7, "signature": "multishot", "min_stats": 4, "max_stats": 5, "min_talents": 3, "max_talents": 3, "stats": { "mag": [55, 105], "multishot": [2, 4], "damage": [70, 120], "reload": [35, 60], "pierce": [2, 4] } },
		{ "id": "r7_hollow", "name": "Hollow", "rarity": 7, "signature": "pierce", "min_stats": 4, "max_stats": 5, "min_talents": 3, "max_talents": 3, "stats": { "pierce": [2, 4], "multishot": [2, 4], "damage": [64, 116], "ricochet": [1, 2], "range": [45, 75] } },
		{ "id": "r7_brutal", "name": "Brutal", "rarity": 7, "signature": "multishot", "min_stats": 5, "max_stats": 6, "min_talents": 3, "max_talents": 3, "stats": { "damage": [80, 140], "multishot": [2, 4], "pierce": [2, 4], "ricochet": [1, 2], "fire_rate": [35, 55], "bullet_speed": [40, 80] } },
		{ "id": "r8_razor",  "name": "Razor",  "rarity": 8, "signature": "damage", "min_stats": 5, "max_stats": 6, "min_talents": 3, "max_talents": 3, "stats": { "damage": [115, 195], "fire_rate": [45, 68], "range": [58, 95], "bullet_speed": [52, 100], "reload": [45, 72], "mag": [55, 105] } },
